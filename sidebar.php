<!-- menu -->
	...
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('leftsidebar') ) : ?>
			...
			<br />
			<?php } ?>
			<p class="blogsyn"><a href="<?php bloginfo('rss2_url'); ?>" title="<?php _e('Syndicate this site using RSS'); ?>"><?php _e('<abbr title="Really Simple Syndication"><img src="http://www.feedburner.com/fb/images/pub/feed-icon16x16.png"></abbr>'); ?></a>
			</p>
			<div class="blogtags"><?php if ( function_exists('wp_tag_cloud') ) : ?></div>
			<!-- available in wp 2.3 -->
			<h4>Popular Tags</h4>
			<p class="blogtags">
